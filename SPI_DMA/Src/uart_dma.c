...
{
	/*Disable DMA stream*/
	DMA1_Stream5->CR &= ~DMA1_SCR_EN;

	/*Wait till DMA is disabled*/
	while(DMA1_Stream5->CR & DMA1_SCR_EN);
	...
	DMA1_Stream5->CR |= DMA1_SCR_TCIE;
	/*Enable circular mode*/
	DMA1_Stream5->CR |= DMA1_SCR_CIRC;
...
{
	/*Disable DMA stream*/
	DMA1_Stream6->CR &= ~DMA1_SCR_EN;

	/*Wait till DMA is disabled*/
	while(DMA1_Stream6->CR & DMA1_SCR_EN);
