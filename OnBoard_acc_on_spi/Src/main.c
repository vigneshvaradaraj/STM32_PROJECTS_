...
//	RCC->CFGR |= (5 << 13);
//
//	//system clock switch by default configured with HSI
//
//}
//
//void spi_gpio_init(void)
//{
//	//enable clock for PORTF and PORTC
//	RCC->AHB1ENR |= (1 << 2) | (1 << 5);
//	//PF7 - CLK
//	//PF8 - MISO
//	//PF9 - MOSI
//	//PC1 - CS
//	GPIOF->MODER |= (2 << 14);//PF7 as AF
//	GPIOF->MODER |= (2 << 16);//PF8 as AF
//	GPIOF->MODER |= (2 << 18);//PF9 as AF
//	GPIOC->MODER |= (2 << 2);//PC1 as AF
//
//	//AF5 is alternate functionality for SPI5
//	GPIOF->AFR[0] |= (AF5 << 28);//SPI5 selected for PF7
//	GPIOF->AFR[1] |= (AF5 << 0);//SPI5 selected for PF7
//	GPIOF->AFR[1] |= (AF5 << 4);//SPI5 selected for PF7
//	GPIOC->AFR[0] |= (AF5 << 4);//SPI5 selected for PF7
//
//}
//
//void spi_init(void)
